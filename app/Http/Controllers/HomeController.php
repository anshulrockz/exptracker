...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $assetoldTotal = Asset::assetoldTotal(); 
        $asset_new = AssetNew::assetnew_pie_chart();
        $assetnewTotal = AssetNew::assetnewTotal(); 
       ...
       foreach($expense_pc as $key => $value)
        ...
        foreach($asset_old as $key => $value)
          ...
          $last_month_e = $deposits[$count_month_e]->m+1;
          }
          

        return view('home')->with(array('expenses' => $expenses, 'deposits' => $deposits, 'asset_old' => $asset_old, 'asset_new' => $asset_new, 'expense_pc' => $expense_pc, 'deposits_2' => $deposits_2,'total_e' => $total_e, 'total_a' => $total_a, 'last_month' => $last_month_d, 'last_month_e' => $last_month_e ));
    }
}
