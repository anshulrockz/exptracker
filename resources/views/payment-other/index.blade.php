        ...
        <div class="card">
            ...
            <div class="body">
                <ol class="breadcrumb breadcrumb-bg-pink">
                    ...
                    <li class="active">Cash Payment</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a class="btn btn-primary waves-effect header-dropdown m-r--5" href="{{route('others.create')}}">Add New</a>
            </div>
            <div class="body">
                <div class="">
                    <table class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else Pending
                                        @if(Auth::user()->user_type == 1 || Auth::user()->user_type == 5 && $list->payment_status == 2)
                                            <a href="{{ url('/payment/others/change-status/'.$list->id)}}" class="btn btn-xs btn-warning"> <i class="material-icons">cancel</i> </a>
                                        @endif
                                    @endif
                                </td>
                                <!-- <td>
                                ...
                                <td>
                                    <!-- <a href="{{ url('/payment/others/'.$list->id)}}" class="btn btn-xs btn-success"> View </a> -->
                                    @if($list->status==1)
                                    <a href="{{ url('/payment/others/'.$list->id.'/edit')}}" class="btn btn-xs btn-info" disabled> <i class="material-icons">edit</i> </a>
...
<!-- Modal Dialogs ====================================================================================================================== -->
            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <form method="get" action="{{url('payment/others/payment')}}">
                                {{ csrf_field() }}
