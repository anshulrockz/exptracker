                            ...
                            <div id="wizard_vertical1">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select class="form-control show-tick" id="make_num" name="make_num">
                                                    <option data-id="{{$list->id}}" value="">-- Please select --</option>
                                ...
                                <section>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="invoice_date" name="invoice_date" class="form-control datepicker" placeholder="Enter invoice date name" value="{{ old('invoice_date') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="invoice_num" name="invoice_num" class="form-control" placeholder="Enter company invoice num" value="{{ old('invoice_num') }}" >
                                                <!-- <label class="form-label" for="name">Customer Category</label> -->
                                            </div>
                                        </div>
                                    </div>
